...
3) perform pairwise comparison of two columns at a time (day 0 vs day 30) 

4) create dataframe from all the boolean series (for each pairwise comparison) and turn the booleans into 0 and 1 

5) get the column index which has lowest sum (as that column contains the highest pairwise false result/mutation)